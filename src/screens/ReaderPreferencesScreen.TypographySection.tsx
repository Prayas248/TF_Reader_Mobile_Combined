...
const styles = StyleSheet.create({
  ...
  // rounded card — see ThemeSection's own note. `md`, not `sm`: font size,
  // letter spacing and page margins are three distinct controls, not one
  // control split in three, so they need real separation between them even
